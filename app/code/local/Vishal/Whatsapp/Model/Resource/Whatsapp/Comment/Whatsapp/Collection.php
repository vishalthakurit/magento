 ...
 */
/**
 * Whatsapp comments resource collection model
 *
 * @category    Vishal
 * @package     Vishal_Whatsapp
 * @author      Ultimate Module Creator
 */
class Vishal_Whatsapp_Model_Resource_Whatsapp_Comment_Whatsapp_Collection extends Vishal_Whatsapp_Model_Resource_Whatsapp_Collection
{
    /**
     * Entities alias
     *
    ...
    protected function _construct()
    {
        ...
        $this->_commentStoreTable = Mage::getSingleton('core/resource')
            ->getTableName('vishal_whatsapp/whatsapp_comment_store');
    }
    ...
    {
        $this->getSelect()->where('ct.whatsapp_id = ?', $entityId);
        return $this;
    }
    ...
    protected function _joinFields()
    {
        $commentTable = Mage::getSingleton('core/resource')
            ->getTableName('vishal_whatsapp/whatsapp_comment');
        $this->getSelect()->join(
            array('ct' => $commentTable),
            'ct.whatsapp_id = main_table.entity_id',
            array(
                'ct_title'      => 'title',
